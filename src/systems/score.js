...
//
//   คะแนน = (ส่วนคน 900 + ส่วนโซน 150 + ส่วนความปลอดภัย 150) × ตัวคูณตอนจบ
...
export function scoreBreakdown(state) {
  ...
  // ถ้าคะแนนถูกดันขึ้นถึงขั้นต่ำ เลขรายส่วนจะบวกกันไม่เท่าคะแนนรวม (0+0+0 แต่รวม 10)
  // ส่งค่าส่วนต่างออกไปให้หน้า Result โชว์เป็นบรรทัดหนึ่ง ผู้เล่นจะได้บวกตามได้ครบ
  const floorBonus = Math.max(0, score - Math.round(raw));
